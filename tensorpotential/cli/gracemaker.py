...
def main(argv=None, strategy=None, strategy_desc=""):
    ...
    if finetune_model and not (
        ...
        # PR #25 (https://github.com/ICAMS/grace-tensorpotential/pull/25):
        # on restart, load model.yaml from the existing run dir so
        # construct_model isn't called (which needs preset/custom).
